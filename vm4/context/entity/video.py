...
class Video(object):
	...
	def __str__(self):
		videoDict = {'f_id':self.__f_id,'f_name':self.__f_name,'f_url':self.__f_url,'f_experiment_id':self.__f_experiment_id,'f_is_delete':self.__f_is_delete,'f_createtime':self.__f_createtime,'f_updatetime':self.__f_updatetime}
		return json.dumps(videoDict,ensure_ascii=False)
